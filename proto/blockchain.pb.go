...
func (m *GetBlockchainResponce) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetBlockchainResponce.Merge(m, src)
}
...
func (*UnimplementedBlockchainServer) GetBlockchain(ctx context.Context, req *GetBlockchainRequest) (*GetBlockchainResponce, error) {
