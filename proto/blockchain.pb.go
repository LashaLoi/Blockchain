...
func (*AddBlockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchain_950254b99c5ef64b, []int{0}
}
...
func (*AddBlockResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchain_950254b99c5ef64b, []int{1}
}
...
func (*GetBlockchainRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchain_950254b99c5ef64b, []int{2}
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchain_950254b99c5ef64b, []int{3}
}
...
type GetBlockchainResponce struct {
...
func (m *GetBlockchainResponce) Reset()         { *m = GetBlockchainResponce{} }
func (m *GetBlockchainResponce) String() string { return proto.CompactTextString(m) }
func (*GetBlockchainResponce) ProtoMessage()    {}
func (*GetBlockchainResponce) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchain_950254b99c5ef64b, []int{4}
}
func (m *GetBlockchainResponce) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetBlockchainResponce.Unmarshal(m, b)
}
func (m *GetBlockchainResponce) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetBlockchainResponce.Marshal(b, m, deterministic)
}
func (dst *GetBlockchainResponce) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetBlockchainResponce.Merge(dst, src)
}
func (m *GetBlockchainResponce) XXX_Size() int {
	return xxx_messageInfo_GetBlockchainResponce.Size(m)
}
func (m *GetBlockchainResponce) XXX_DiscardUnknown() {
	xxx_messageInfo_GetBlockchainResponce.DiscardUnknown(m)
}

var xxx_messageInfo_GetBlockchainResponce proto.InternalMessageInfo

func (m *GetBlockchainResponce) GetBlocks() []*Block {
	if m != nil {
		return m.Blocks
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GetBlockchainResponce)(nil), "proto.GetBlockchainResponce")
}
...
type BlockchainClient interface {
	...
	GetBlockchain(ctx context.Context, in *GetBlockchainRequest, opts ...grpc.CallOption) (*GetBlockchainResponce, error)
}
...
func (c *blockchainClient) GetBlockchain(ctx context.Context, in *GetBlockchainRequest, opts ...grpc.CallOption) (*GetBlockchainResponce, error) {
	out := new(GetBlockchainResponce)
...
type BlockchainServer interface {
	...
	GetBlockchain(context.Context, *GetBlockchainRequest) (*GetBlockchainResponce, error)
}
...
func init() { proto.RegisterFile("proto/blockchain.proto", fileDescriptor_blockchain_950254b99c5ef64b) }

var fileDescriptor_blockchain_950254b99c5ef64b = []byte{
	...
	0x84, 0x3b, 0x8b, 0x19, 0xc9, 0x59, 0xb6, 0x5c, 0xa2, 0x68, 0xd6, 0x81, 0xdc, 0x96, 0x9c, 0x2a,
	0xa4, 0xc2, 0xc5, 0x06, 0xf6, 0x71, 0xb1, 0x04, 0xa3, 0x02, 0xb3, 0x06, 0xb7, 0x11, 0x0f, 0xc4,
	0xd7, 0x7a, 0x10, 0x1f, 0x40, 0xe5, 0x8c, 0xa6, 0x32, 0x72, 0x71, 0x21, 0x34, 0x0b, 0x59, 0x73,
	0x71, 0xc0, 0x3c, 0x29, 0x24, 0x06, 0xd5, 0x80, 0x16, 0x38, 0x52, 0xe2, 0x18, 0xe2, 0xd0, 0xd0,
	0xf0, 0xe2, 0xe2, 0x45, 0x71, 0x8a, 0x90, 0x34, 0x54, 0x25, 0xb6, 0xf0, 0x90, 0x92, 0xc1, 0x2e,
	0x09, 0x71, 0x7d, 0x12, 0x1b, 0x58, 0xd2, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x94, 0x5c, 0x4f,
